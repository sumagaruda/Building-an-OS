...
void GenerateVMPoolMemoryReferences(VMPool *pool, int size1, int size2) {
   ...
   for(int i=1; i<size1; i++) {
      ...
      Console::puti(size2*i);
      //Console::puts("The array gets initialized correctly");
      //Console::puti(pool->is_legitimate((unsigned long)arr));
      Console::puts("\n");
  ...
  Console::puts("This functions completes");
}
